...
/* Configuration date */
#define ZORP_CONFIG_DATE "2014/06/10"

/* datadir */
#define ZORP_DATADIR "/usr/local/share/zorp"

/* libdir */
#define ZORP_LIBDIR "/usr/local/lib/zorp"

/* Required license version */
#define ZORP_LICENSE_VERSION "5.0"

/* pidfiledir */
#define ZORP_PIDFILEDIR "/usr/local/var/run/zorp/"

/* Required product name in license */
#define ZORP_PRODUCT_NAME "Zorp Professional"

/* Zorp source revision number */
#define ZORP_SOURCE_REVISION "ssh+git://coroner@git.balabit/var/scm/git/zorp/zorp-core--mainline--5.0"

/* localstatedir */
#define ZORP_STATEDIR "/usr/local/var"

/* sysconfdir */
#define ZORP_SYSCONFDIR "/usr/local/etc/zorp"
